	...
	switch ( $comment->comment_type ) {
		...
		case 'trackback' :
			...
			<li class="post pingback">
				<p><?php _e( 'Pingback:', 'comunidade-wordpress-br' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( 'Edit', 'comunidade-wordpress-br' ), ' <span class="label label-primary pull-right edit-link">', '</span>' ); ?></p>
				<?php
				break;
			default :
				?>
				...
				<article id="comment-<?php comment_ID(); ?>" class="comment" itemscope itemtype="http://schema.org/UserComments">
					<footer class="comment-meta">
						<div class="comment-author vcard">
							...
							<?php edit_comment_link( __( 'Edit', 'comunidade-wordpress-br' ), '<span class="label label-primary pull-right edit-link">', '</span>' ); ?>
